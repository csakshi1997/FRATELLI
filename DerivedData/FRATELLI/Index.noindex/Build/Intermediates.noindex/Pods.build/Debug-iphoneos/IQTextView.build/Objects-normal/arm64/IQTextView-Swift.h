...
#ifndef IQTEXTVIEW_SWIFT_H
#define IQTEXTVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IQTextView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10IQTextView10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQTextView (SWIFT_EXTENSION(IQTextView)) <IQPlaceholderable>
@end
